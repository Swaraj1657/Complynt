        ...
        try {
            ...
            for (Message message : messages) {
                try {
                    ...
                    // Process it the exact same way as the webhook did!
                    emailComplaintService.processEmailComplaint(payload);

                    // Mark as seen so we don't process it again
                    message.setFlag(Flags.Flag.SEEN, true);
                    System.out.println("✅ IMAP received and processed complaint from: " + sender);
                } catch (Exception e) {
